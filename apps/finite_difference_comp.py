...
def main(args):
    ...
    img = render(w,  # width
                 ...
                 *scene_args)
    pydiffvg.imwrite(img.cpu(), f'results/finite_difference_comp/{case_name}_{use_prefiltering}/img.png', gamma=1.0)
    ...
    pydiffvg.imwrite(x_diff, f'results/finite_difference_comp//{case_name}_{use_prefiltering}/finite_x_diff.png', gamma=1.0)
    ...
    pydiffvg.imwrite(y_diff, f'results/finite_difference_comp/{case_name}_{use_prefiltering}/finite_y_diff.png', gamma=1.0)
    perturb_scene(1, epsilon)
    ...
    pydiffvg.imwrite(x_diff, f'results/finite_difference_comp/{case_name}_{use_prefiltering}/ours_x_diff.png', gamma=1.0)
    pydiffvg.imwrite(y_diff, f'results/finite_difference_comp/{case_name}_{use_prefiltering}/ours_y_diff.png', gamma=1.0)
